...
export function landingPage(
  ...
  <section class="hero">
    <div class="container">
      ...
      <!-- Live OG preview.
           This src used to be /og?title=… with no key. /og answers 401 without
           one — correctly — so this image was broken for every visitor who ever
           loaded the page. It is now /demo.png: keyless, fixed content, rendered
           through the same buildElement path a paying request takes. Do not
           point it back at /og; an anonymous page cannot embed an authenticated
           endpoint, and a key in this HTML would be a public key. -->
      <div class="og-preview-wrap" style="margin-top:56px;">
        <div class="og-preview-label">1200 × 630 PNG — rendered by this API</div>
        <img
          src="/demo.png"
          width="1200"
          height="630"
          alt="Example Open Graph card generated by OGForge: 'How We Cut Cold-Start Latency by 80%'"
